...
public class GuestReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emailTo = getIntent().getStringExtra("owner_email"); //
        emailFrom = getIntent().getStringExtra("guest_email");
...
//
                ...
                if (reason.length() < 10) {
                    Toast.makeText(GuestReportActivity.this, "Comment must be at least 10 characters long", Toast.LENGTH_SHORT).show();
                    return;
                } else {
                    ...
                    call.enqueue(new Callback<Void>() {
                        ...
                        public void onResponse(Call<Void> call, Response<Void> response) {
                            if (response.isSuccessful()) {
                                Toast.makeText(GuestReportActivity.this, "Successfully reported!", Toast.LENGTH_SHORT).show();
                        ...
                        public void onFailure(Call<Void> call, Throwable t) {
                            ...
                            Toast.makeText(GuestReportActivity.this, "e:" + message, Toast.LENGTH_SHORT).show();
                        }
                    });
                }
